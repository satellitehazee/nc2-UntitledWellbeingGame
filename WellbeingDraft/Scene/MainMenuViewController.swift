...
protocol UpdateGalleryEnding: AnyObject{
    func passScene(newSceneList: [Scene])
}
...
class MainMenuViewController: UIViewController, UpdateGalleryEnding {
    ...
    var sceneList: [Scene] = [
        Scene(sceneId: 1, sceneName: "Presentation", sceneDescription: "You finally presented your app to everyone in the Academy.\nThank you for playing the game!", sceneImage: "Scene01", isUnlocked: false),
        Scene(sceneId: 2, sceneName: "Development Success!", sceneDescription: "Everything went out smoothly; Development finished on time, and you're living well.", sceneImage: "Scene02", isUnlocked: false),
